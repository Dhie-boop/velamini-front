...
Respond concisely and helpfully.`;
  ...
  const onKey = (e: React.KeyboardEvent<HTMLTextAreaElement>) => {
    // On desktop: Enter sends. On mobile, Enter key events are unreliable —
    // the send button is the primary path there.
  ...
  return (
    <>
      <style>{`
        ...
        @media(min-width:1024px){ .dc { height: calc(100vh - 56px); max-height: calc(100vh - 56px); } }
        ...
        /* Empty state — no flex:1 so it doesn't break scroll container height */
        .dc-empty {
          display: flex; flex-direction: column;
      ...
      <div className="dc">
        ...
        <div className="dc-input-wrap">
          ...
          <div className="dc-hint">Tap ↑ to send · Shift+Enter for new line</div>
        </div>
      </div>
    </>
  );
